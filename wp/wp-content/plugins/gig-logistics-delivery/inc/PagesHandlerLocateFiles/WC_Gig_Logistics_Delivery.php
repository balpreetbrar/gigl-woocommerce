<?php
	...
	/**
		...
		*
		* @class  WC_Gig_Logistics_Delivery
	*/
	class WC_Gig_Logistics_Delivery
	{
		/** @var \WC_Gig_Logistics_Delivery_API api for this plugin */
		public $api;
		...
		/** @var \WC_Gig_Logistics_Delivery single instance of this plugin */
		...
		*/
		public function includes()
		{
			...
			require_once $plugin_path . 'inc/BaseHandlerLocateFiles/WC_Gig_Logistics_Delivery_API.php';
			
			require_once $plugin_path . 'inc/BaseHandlerLocateFiles/WC_Gig_Logistics_Delivery_Shipping_Method.php';
		}
		...
		public function admin_includes()
		{
			...
			require_once $plugin_path . 'inc/BaseHandlerLocateFiles/WC_Gig_Logistics_Delivery_Orders.php';
		}
...
$note = sprintf(
		...
		public function add_view_order_tracking($order)
		{
			...
			if (isset($delivery_tracking_url) && !empty($delivery_tracking_url)) {
				if(empty($gigl_waybill)){ ?>
					<p class="wc-gigl-logistics-delivery-track-deliverys"><span style="padding:20px 0px;">Refresh page if track page/button not visible</span>
  ...
  <!-- Modal content -->
			   ...
			   <ul>
				...
				<ul>
				  ...
				  <li><?php if (
								...
								isset($res->data[0]->MobileShipmentTrackings) &&
								!empty($res->data[0]->MobileShipmentTrackings)
							) {  foreach($res->data[0]->MobileShipmentTrackings as $MobileShipmentTrackings){ $getStatusVal = $MobileShipmentTrackings->Status ."<br>"; echo wp_kses( $getStatusVal, array( 'br' => array(),) );}}  ?>
				  </li>
				</ul>
			  </div>
		...
		*/
		...
		{
			$this->shipping_method = new WC_Gig_Logistics_Delivery_Shipping_Method;
		}
		...
		*/
		...
		{
			if (class_exists('WC_Gig_Logistics_Delivery_Shipping_Method')) :
            $methods['gig_logistics_delivery'] = 'WC_Gig_Logistics_Delivery_Shipping_Method';
			endif;
		...
		/**
			...
			* @since 1.0
			*
			* @return \WC_Gig_Logistics_Delivery_API instance
		*/
		public function get_api()
		{
			...
			// instantiate API
			return $this->api = new WC_Gig_Logistics_Delivery_API($gig_logistics_delivery_settings);
		}
		...
		/**
			...
			* @since 1.0.0
			*
			* @return \WC_Gig_Logistics_Delivery
		*/
	...
	/**
		...
		* @return \WC_Gig_Logistics_Delivery
	*/
	function wc_gig_logistics_delivery()
	{
		return \WC_Gig_Logistics_Delivery::instance();
	}
