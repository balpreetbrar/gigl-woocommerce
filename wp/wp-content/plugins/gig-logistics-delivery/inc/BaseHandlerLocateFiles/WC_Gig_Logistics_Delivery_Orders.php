	...
	class WC_Gig_Logistics_Delivery_Orders
	{
		...
		*/
		public function __construct()
		{
			...
			add_action('woocommerce_order_action_wc_gig_logistics_delivery_update_status', array($this, 'process_order_meta_box_actions'));
...
.text('<?php echo esc_html( __( "Update Order Status (via gigl delivery)", "gigl-logistics-delivery" ) ); ?>');
		...
		*/
		public function add_order_meta_box_actions($actions)
		{
			...
			$actions['wc_gig_logistics_delivery_update_status'] = __('Update Order Status (via gigl delivery)');
		...
		*/
		...
		/**
			* Add 'Gig Logistics Delivery Information' meta-box to 'Edit Order' page
			*
			* @since 1.0
		*/
		...
		/**
			* Display the 'Gig Logistics Delivery Information' meta-box on the 'Edit Order' page
			*
			* @since 1.0
		*/
        ...
        <table id="wc_gig_logistics_delivery_order_meta_box">
            ...
            <tr>
                ...
                <td>
                    <?php echo wp_kses($order->get_meta('gig_logistics_delivery_status_res')); ?>
				</td>
			</tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo wp_kses($order->get_meta('gig_logistics_delivery_tracking_id')); ?>
				</td>
			</tr>
		</table>
		<?php
		...
		/**
			...
			*
			*
			* @return \WC_Gig_Logistics_Delivery_Loader
		*/
