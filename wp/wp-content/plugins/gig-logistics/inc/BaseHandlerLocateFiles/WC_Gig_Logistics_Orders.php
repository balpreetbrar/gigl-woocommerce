<?php
	...
	/**
		...
		* @since 1.0
	*/
	class WC_Gig_Logistics_Orders
	{
		/** @var \WC_Gig_Logistics_Orders single instance of this class */
		...
		*/
		public function __construct()
		{
			...
			add_action('woocommerce_order_action_wc_gig_logistics_update_status', array($this, 'process_order_meta_box_actions'));
		...
		public function add_order_bulk_actions()
		{
            ...
            <script type="text/javascript">
                jQuery(document).ready(function($) {
					...
					$('<option>').val('update_order_status').text('<?php _e('Update Order Status (via GIG Logistics)'); ?>')
                    );
				});
			</script>
			<?php
		...
		public function process_order_bulk_actions()
		{
			...
			if ('shop_order' == $typenow) {
				...
				foreach ($order_ids as $order_id) {
					try {
						wc_gig_logistics()->update_order_shipping_status($order_id);
						} catch (\Exception $e) {
					}
				}
			}
		...
		*/
		public function add_order_meta_box_actions($actions)
		{
			...
			$actions['wc_gig_logistics_update_status'] = __('Update Order Status (via GIG Logistics)');
		...
		*/
		...
		{
			wc_gig_logistics()->update_order_shipping_status($order);
		}
		...
		*/
		...
		{
			add_meta_box(
			'wc_gig_logistics_order_meta_box',
			__('GIG Logistics'),
		...
		*/
		public function render_order_meta_box()
		{
			...
			$gigl_order_id = $order->get_meta('gig_logistics_waybill');
		...
		<table id="wc_gig_logistics_order_meta_box">
            <tr>
            ...
            <tr>
                ...
                <td>
					<?php echo wp_kses($order->get_meta('gig_logistics_status_res'), array()); ?>
				</td>
			</tr>
            ...
            <tr>
                ...
                <td>
					<?php echo wp_kses($order->get_meta('gig_logistics_tracking_id'), array()); ?>
				</td>
			</tr>
		</table>
		<?php
		...
		/**
			...
			*
			*
			* @return \WC_Gig_Logistics_Orders
		*/
	...
	// fire it up!
	return WC_Gig_Logistics_Orders::instance();
