...
class Admin_GIGL_Handler_Class extends Base_Controller_Handler_Class
{
	...
	public function __construct()
	{
		...
		$this->pages = array(
			array(
				'page_title' => 'GIG Logistics', 
				'menu_title' => 'GIG Logistics', 
				'capability' => 'manage_options', 
				'menu_slug' => 'gig_logistics_plugin', 
		...
		$this->subpages = array(
			array(
				'parent_slug' => 'gig_logistics_plugin', 
				'page_title' => 'GIGL Settings', 
				'menu_title' => 'GIGL Settings', 
				'capability' => 'manage_options', 
				'menu_slug' => 'wc-settings&tab=shipping&section=gig_logistics', 
